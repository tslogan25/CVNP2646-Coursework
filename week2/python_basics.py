...
if threat_level >= 8:
    ...
    print("Satus: NORMAL - No immediate threats")
...
def calculate_risk_score(vulnerabilities, threat_level, patch_status):
    ...
    patch_modifier = 20 if patch_status == "outdated" else 0

    risk_score = min(base_score + threat_modifier + patch_modifier, 100)
    return risk_score
...
if score >= 70:
    ...
    print("   MEDIUM RISK - Schedule updates soon")
else:
...
if check_ip in allowed_ips:
    print(f"✅ (check_ip) is allowed access")
else:
